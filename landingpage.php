...
<section class="featured fade-in">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="dish-card">
                    <img src="/assets/scalap.jpg">
                    <h3>Pan-Seared Scallops with Pea Purée</h3>
                </div>
            </div>
...
<section class="footer fade-in">
   <footer class="footer">
    ...
    <div class="footer-bottom">
        <p>&copy; 2025 Luxe Fine Dining. All Rights Reserved.</p>
    </div>
</footer>
</section>
